...
export default function Donate() {
    ...
    const fetchRecentLogin = async (auth, mail) => {
        var options = {
            method: 'GET',
            url: 'https://the-ACDA-ngo-server.onrender.com/api/v1/registration/getLogs?email=' + mail,
            headers: {
    ...
    const handleSubmit = async (e) => {
        ...
        if (isLogin) {
            ...
            var options = {
                method: 'POST',
                url: 'https://the-ACDA-ngo-server.onrender.com/api/v1/donate/pay',
                headers: {
            ...
            try {
                ...
                var get_razKey = {
                    method: 'GET',
                    url: 'https://the-ACDA-ngo-server.onrender.com/api/v1/donate',
                    headers: {
                        Authorization: `Basic ${password}`,
                        'Content-Type': 'application/json'
                    },
                ...
                const options = {
                    ...
                    currency,
                    name: "The ACDA NGO :)",
                    description: "Donation for ACDA Charity purpose.",
                    ...
                    handler: async function (response) {
                        ...
                        var options = {
                            method: 'POST',
                            url: 'https://the-ACDA-ngo-server.onrender.com/api/v1/donate/pay/verify',
                            headers: {
                                Authorization: `Basic ${password}`,
                                'Content-Type': 'application/json'
                            },
    ...
    const handleEmail = async () => {
        ...
        if (regex.test(String(email).toLowerCase())) {
            const url = "https://the-ACDA-ngo-server.onrender.com/api/v1/registration?email=" + String(email).toLowerCase();
            await axios.get(url)
                .then(response => {
    ...
    const handleLogin = async () => {
        const options = {
            method: 'POST',
            url: 'https://the-ACDA-ngo-server.onrender.com/api/v1/registration/auth',

...
function Admin() {
    ...
    const adminLogin = async () => {
        MySwal.fire({
            ...
            preConfirm: async () => {
                try {
                    const url = `https://the-AMANA-ngo-server.onrender.com/api/v1/registration/auth`;
    ...
    const fetchDonations = async (auth1) => {
        var options = {
            method: 'GET',
            url: 'https://the-AMANA-ngo-server.onrender.com/api/v1/search/allDonations',
            headers: {
    ...
    const fetchUserInfo = async (mail) => {
        var options = {
            method: 'GET',
            url: 'https://the-AMANA-ngo-server.onrender.com/api/v1/search/donations?email=' + mail,
            headers: {
    ...
    const search = async () => {
        ...
        var options = {
            method: 'GET',
            url: 'https://the-AMANA-ngo-server.onrender.com/api/v1/search/' + query,
            headers: {
                Authorization: `Basic ${auth}`,
                'Content-Type': 'application/json'
            },
                                ...
                                <div className="popupContent" id="myPopup">
                                    ...
                                    <div className="card">
                                        <div className="card-body">
                                            <h1 className="text-center text-warning p-3 bg-dark rounded-top-4">THE ACDA NGO</h1>

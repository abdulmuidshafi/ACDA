            ...
            <div className="container copyright">
                <div className="row">
                    <div className="col-md-6">
                        <p>&copy; <a href="#">THE ACDA NGO</a> | 2024, All Right Reserved.</p>
                    </div>
                    <div className="col-md-6">
                        <p>Designed By <a href="https://www.linkedin.com/in/bhavesh-patil-92b7aa22a">software developer,Abdulmuid Shafi</a></p>
                    </div>
                </div>
            </div>
        </ div>
